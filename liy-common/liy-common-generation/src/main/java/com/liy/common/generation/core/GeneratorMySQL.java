...
public class GeneratorMySQL {
     ...
     * 数据库连接url
     */
    public static final String URL = "jdbc:mysql://8.134.121.204/liycloud";
    /**
     * 数据库 用户名
     */
    public static final String USER_NAME = "LiyCloud";
    /**
     * 数据库 密码
     */
    public static final String PASSWORD = "liy200110";
    /**
     * 作者
     */
    public static final String AUTHOR = "liy";
    /**
     * java代码保存目录
     */
//    public static final String SAVE_PATH = System.getProperty("user.dir") + "/src/main/java";
    public static final String SAVE_PATH = "liy-common\\liy-common-generation\\src\\main\\java";
    /**
     * xml保存目录
     */
    public static final String XML_SAVE_PATH ="liy-common/liy-common-generation/src/main/java/com/liy/common/generator/new/xml";
    /**
     * 保存到包下面
     */
    public static final String PACKAGE = "com.liy.common.generator";
    /**
     * 要生成的表
     */
    public static final String[] TABLES = {"category"};
...
//                        .addFieldPrefix("sys_") // 增加过滤字段前缀
                        ...
                        .formatFileName("%sPo") // Entity 文件名称
